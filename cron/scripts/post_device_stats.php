...
$aaa = exec("curl -s https://streamcloud.homepi.org/api/api.php --data \"action=device_keepalive_rpi&hardware=$hardware&revision=$revision&sn=$sn&localip=localip&cpuTemp=$cpuTemp&gpuTemp=$gpuTemp&loadavg1=$load_average1&loadavg5=$load_average5&loadavg15=$load_average15&sysuptime=$uptime&net_ifaces=$net_ifaces\"");
